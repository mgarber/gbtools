...
public class RNAiGeneAnnotation {
	...
	public RNAiGeneAnnotation(RefSeqGene gene, Alignments linc, String geneName, int versionNumber, String seq, String species, String ncbiBuild){
		this.gene=gene;
		...
		geneSourceStrand=gene.getOrientation();
		geneCreateDate="NA";
		geneUpdateDate="NA";
