...
public class GetPairedKnownAndNovel5Prime {

	public GetPairedKnownAndNovel5Prime(Collection<RefSeqGene> novel5Prime, Collection<RefSeqGene> genes, ContinuousDataAlignmentModel data, String save) throws IOException{
	...
	public static void main(String[] args)throws IOException{
		if(args.length>4){
			...
			new GetPairedKnownAndNovel5Prime(novel5Prime, genes, data, save);
		}
