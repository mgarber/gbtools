...
// the member function get_Q is for getting one column from the Q com.scanfeld.math.Matrix
...
class Solver
{
  ...
  public static Texts err;
  public static Texts out;
  ...
  public static void err ( String z )
  {
    err.rpush ( z );
  }

  public static void out ( String z )
  {
    out.rpush ( z );
  }
...
public class svm
{
                                      ...
                                      double[] probAB )
  {
    ...
    for ( iter = 0; iter < max_iter; iter++ )
    {
      ...
      {
        err ( "Line search fails in two-class probability estimates\n" );
        break;
      }
    }
    ...
    if ( iter >= max_iter )
    {
      err ( "Reaching maximal iterations in two-class probability estimates\n" );
    }
    probAB[ 0 ] = A;
    probAB[ 1 ] = B;
  }
  ...
  private static void multiclass_probability ( int k, double[][] r, double[] p )
  {
    ...
    if ( iter >= max_iter )
    {
      err ( "Exceeds max_iter in multiclass_prob\n" );
    }
  }
  ...
  private static void svm_binary_svc_probability ( svm_problem prob, svm_parameter param, double Cp, double Cn, double[] probAB )
  {
    ...
    for ( i = 0; i < prob.l; i++ )
    {
      int j = i + ( int ) ( inc.randDouble () * ( prob.l - i ) );
      do
      {
        int _ = perm[ i ];
        perm[ i ] = perm[ j ];
  ...
  private static double svm_svr_probability ( svm_problem prob, svm_parameter param )
  {
    ...
    mae /= ( prob.l - count );
    err ( "Prob. model for test data: target value = predicted value + z,\nz: Laplace distribution e^(-|z|/sigma)/(2sigma),sigma=" + mae + "\n" );
    return mae;
  }
  ...
  public static svm_model svm_train ( svm_problem prob, svm_parameter param )
  {
    ...
    else
    {
      ...
      for ( i = 0; i < param.nr_weight; i++ )
      {
        ...
        if ( j == nr_class )
        {
          err ( "warning: class label " + param.weight_label[ i ] + " specified in weight is not found\n" );
        }
        else
        {
  ...
  public static void svm_cross_validation ( svm_problem prob, svm_parameter param, int nr_fold, double[] target )
  {
            ...
            param.svm_type == svm_parameter.NU_SVC ) && nr_fold < l )
    {
      ...
      for ( c = 0; c < nr_class; c++ )
      {
        for ( i = 0; i < count[ c ]; i++ )
        {
          int j = i + ( int ) ( inc.randDouble () * ( count[ c ] - i ) );
          do
          {
    ...
    else
    {
      ...
      for ( i = 0; i < l; i++ )
      {
        int j = i + ( int ) ( inc.randDouble () * ( l - i ) );
        do
        {
          int _ = perm[ i ];
          perm[ i ] = perm[ j ];
  ...
  public static double svm_get_svr_probability ( svm_model model )
  {
    ...
    {
      err ( "Model doesn't contain information for SVR probability inference\n" );
      return 0;
    }
  }
  ...
  public static svm_model svm_load_model ( String model_file_name ) throws IOException
  {
    ...
    while ( true )
    {
      ...
      {
        err ( "unknown text in model file: [" + cmd + "]\n" );
        return null;
      }
    }
